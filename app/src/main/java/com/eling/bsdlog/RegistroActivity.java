...
public class RegistroActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( bundle != null ) {
            ...
            ArrayList<String> reg = sqlite.getFormatListUsr(cursor);
    ...
    public void onClick(View v ) {
        ...
        {
            case R.id.btnNuevo:
                Intent iMain = new Intent( RegistroActivity.this, ActividadPrincipal.class );
                startActivity( iMain );
                break;
            case R.id.btnDelete:
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setTitle("Eliminar")
                        .setMessage("En verdad desea eliminar este usuario?")
